 ...
 */
export declare abstract class Identity implements IIdentity {
    readonly name: string;
    readonly isAuthenticated: boolean;
    /**
 ...
 * @sealed
 */
export declare class AnonymousIdentity extends Identity implements IAnonymousIdentity, IIdentity {
    /**
