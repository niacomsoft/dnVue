 ...
 */
export abstract class Credentials implements ICredentials { }
 ...
 * @implements {ICredentials}
 */
export class BasicCredentials extends Credentials implements IBasicCredentials, ICredentials {
    readonly userName: string;
    readonly password: string;
 ...
 * @implements {ICredentials}
 */
export class SecureBasicCredentials extends BasicCredentials implements ISecureBasicCredentials, IBasicCredentials, ICredentials {
    /**
    ...
    constructor(userName: string, password: string, hashAlg?: dnvue.security.IHashAlgorithm) {
        ...
        this.hashAlgorithm = Object.safeGet<dnvue.security.IHashAlgorithm>(hashAlg, new SHA1AlgorithmProvider());
